...
![Alvin's GitHub stats](https://github-readme-stats.vercel.app/api?username=alvinadefuin&show_icons=true&theme=radical)

## 📌 Pinned Repository: AI-Powered Portfolio

This repository contains my **AI-powered portfolio** built with cutting-edge technologies!
...
- ⚡ **SEO Optimized** - Built-in Next.js metadata API
...
The portfolio is fully customizable through `portfolio-config.json`. You can easily modify:
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/alvinadefuin/alvinadefuin)

1. Fork this repository
2. Update `portfolio-config.json` with your information
...
- **Inspired by**: [Anuj Jain's Portfolio](https://github.com/anujjainbatu/portfolio) - Special thanks for the design inspiration
